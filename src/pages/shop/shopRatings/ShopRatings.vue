        ...
        <div class="ratings-content">
            ...
            <div class="ratingselect">
                <div class="rating-type border-1px">
                    <span class="block positive" :class="{active: selectType === 2}" @click="updateSelectType(2)">
                        全部
                        <span class="count">{{shopRatings.length}}</span>
                    </span>
                    <span class="block positive" :class="{active: selectType === 0}" @click="updateSelectType(0)">
                        满意
                        <span class="count">{{positiveSize}}</span>
                    </span>
                    <span class="block negative" :class="{active: selectType === 1}" @click="updateSelectType(1)">
                        不满意
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            filterShopRatings() {
                // 过滤数组
                let {selectType, onlyShowText, shopRatings} = this;
