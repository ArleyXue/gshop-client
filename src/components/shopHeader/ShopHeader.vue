<template>
    <div class="shop-header">
        <nav class="shop-nav" :style="{backgroundImage: `url(${shopInfo.bgImg})`}" @click="$router.back()">
            <a class="back">
        ...
        <div class="shop-header-discounts" @click="showShopActivity" v-if="shopInfo.supports">
        ...
        <transition name="fade">
            <div class="activity-sheet" v-if="shopActivityShow">
            <div class="activity-sheet-content">
                <h2 class="activity-sheet-title">优惠活动</h2>
                <ul class="list">
                    <li class="activity-item" :class="activityClasses[activity.type]" v-for="(activity, index) in shopInfo.supports" :key="index">
                        <span class="content-tag">
                ...
                <div class="activity-sheet-close" @click="showShopActivity">
                    <span class="iconfont icon-close"></span>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showShopActivity() {
                this.shopActivityShow = !this.shopActivityShow;
            }
        }
